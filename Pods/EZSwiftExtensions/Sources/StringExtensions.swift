...
extension String {
    ...
    //        let underlineString = NSAttributedString(string: self, attributes: [NSAttributedStringKey.underlineStyleNSAttributedStringKey.underlineStyle: NSUnderlineStyle.styleSingle.rawValue])
